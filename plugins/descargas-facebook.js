...
if (!args[0]) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝑰𝒏𝒈𝒓𝒆𝒔𝒆 𝒖𝒏 𝒆𝒏𝒍𝒂𝒄𝒆 𝒑𝒂𝒓𝒂 𝒅𝒆𝒔𝒄𝒂𝒓𝒈𝒂𝒓 𝒆𝒍 𝒗𝒊𝒅𝒆𝒐\n𝑬𝒋𝒆𝒎𝒑𝒍𝒐:\n*${usedPrefix + command} https://www.facebook.com/watch?v=636541475139*`, fkontak, m)
if (!args[0].match(/www.facebook.com|fb.watch/g)) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}𝑰𝒏𝒈𝒓𝒆𝒔𝒆 𝒖𝒏 𝒆𝒏𝒍𝒂𝒄𝒆 𝒑𝒂𝒓𝒂 𝒅𝒆𝒔𝒄𝒂𝒓𝒈𝒂𝒓 𝒆𝒍 𝒗𝒊𝒅𝒆𝒐\n𝑬𝒋𝒆𝒎𝒑𝒍𝒐:\n*${usedPrefix + command} https://www.facebook.com/watch?v=636541475139*`, fkontak, m)
const sections = [
{
title: htjava + ' 📡 𝙇𝙄𝙎𝙏𝘼 𝘿𝙀 𝘿𝙀𝙎𝘾𝘼𝙍𝙂𝘼𝙎 ' + htjava,
rows: [
{title: "📡 𝑭𝒂𝒄𝒆𝒃𝒐𝒐𝒌 (𝙤𝙥𝙘𝙞𝙤𝙣 1) ", rowId: `${usedPrefix}fb1 ${args[0]}`},
{title: "📡 𝑭𝒂𝒄𝒆𝒃𝒐𝒐𝒌 (𝙤𝙥𝙘𝙞𝙤𝙣 2) ", rowId: `${usedPrefix}fb2 ${args[0]}`},
...
const listMessage = {
text: `𝑺𝒆𝒍𝒆𝒄𝒄𝒊𝒐𝒏𝒆 𝒖𝒏𝒂 𝒐𝒑𝒄𝒊𝒐𝒏 𝒑𝒂𝒓𝒂 𝒑𝒐𝒅𝒆𝒓 𝒅𝒆𝒔𝒄𝒂𝒓𝒈𝒂𝒓`,
footer: `*𝗣𝗥𝗘𝗠𝗜𝗨𝗠 ${user.premium ? "✅": "❌"}*\n$`,
title: `*⎔───ꕤ 📡 𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 ꕤ───⎔*`,
buttonText: `🛰️ 𝙀𝙡𝙚𝙜𝙞𝙧 𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖 🛰️`,
sections }  
try {
let contenido = `✅ 𝑽𝒊𝒅𝒆𝒐 𝒅𝒆 𝑭𝒂𝒄𝒆𝒃𝒐𝒐𝒌\n${wm}`
switch (command) { 
...
await m.reply(`${lenguajeGB['smsAvisoFG']()}𝑨𝒍𝒈𝒐 𝒔𝒂𝒍𝒊𝒐 𝒎𝒂𝒍, 𝒓𝒆𝒄𝒖𝒆𝒓𝒅𝒆 𝒖𝒔𝒂𝒓 𝒖𝒏 𝒆𝒏𝒍𝒂𝒄𝒆 𝒅𝒆 𝒇𝒂𝒄𝒆𝒃𝒐𝒐𝒌 𝒗𝒂𝒍𝒊𝒅𝒐`)
}}
